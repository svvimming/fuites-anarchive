...
const initSoundThingie = () => {
  ...
  const path = ['/music/8-fevr-1657.mp3', '/music/63be.mp3']
  player.value.src = path[Math.floor(Math.random() * path.length)] //`${baseUrl.value}/uploads/${props.fileRef._id}.${props.fileRef.file_ext}`
